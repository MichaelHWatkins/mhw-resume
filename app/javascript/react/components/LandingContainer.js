      ...
      <div className='backgroundLanding container'>
        <div className='row'>
          <div className='personalinfo col-4'>
            ...
            <img src={me} alt='me' />
            <div className="row">
              <div className="col-6"><h4 className="bold">role desired</h4><p>Jr. Developer</p></div>
              <div className="col-6"><h4 className="bold">location</h4><p>Boston</p></div>
            </div>
            <div className="row">
          ...
          <div className='aboutme col-6'>
            ...
            <div className='row'>
              <div className="col-3"><a href="https://github.com/MichaelHWatkins"><img className="gitlogo" src={github}/></a></div>
              <div className="col-3"><a href="https://www.linkedin.com/in/michael-h-watkins/"><img className="linklogo" src={linkedin}/></a></div>
              <div className="col-3"><a href="https://launchpass.launchacademy.com/users/MichaelWatkins2567/launcher_profile"><img className="launchlogo" src={launch}/></a></div>
            </div>
          </div>
